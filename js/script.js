function calculateBMI() {
    ...
    if (bmi < 18.5) {       //pengambilan kondisi saat BMI dibawah 18,5
        ...
        description = "Berat badan anda kurang dari 18,5<br>Cara menambah berat badan paling baik adalah dengan mengatasi penyakit atau kondisi yang menjadi penyebab berkurangnya berat badan. Bila kondisi tersebut bisa diatasi, berat badan pun akan bertambah."
    } else if (bmi < 25) {  //pengambilan kondisi saat BMI diantara 18,5 - 24,9
        category = "Berat badan normal";
        description = "Berat badan anda normal diantara 18,5 - 24,9<br>Memiliki berat badan yang ideal tidak harus dengan diet ekstrem yang menyiksa. Ada beberapa cara menjaga berat badan ideal dengan aman yang bisa Anda lakukan.<br>Diantaranya yaitu menyusun meal plan, bergerak aktif atau olahraga, dan jangan lewatkan sarapan"
    } else if (bmi < 30) {  //pengambilan kondisi saat BMI diantara 25,0 - 29,9
        category = "Berat badan berlebih";
        description = "Berat badan anda lebih dari 25,0 - 29,9<br>Cara terbaik menurunkan berat badan adalah dengan berolahraga, menjaga pola makan tetap teratur."
    } else if (bmi > 30) {
        category = "Obesitas";  //pengambilan kondisi saat BMI diatas 30
        description = "Berat badan anda lebih dari 30<br>Anda dikategorikan kedalam Overweight dimana hal ini adalah sebuah penyakit yang kompleks. Overweight dapat dipengaruhi oleh pola makan yang tidak teratur, pola tidur yang tidak sehat, dan kurangnya olahraga."
    } else {
        category = "Tidak diketahui"
    }

    //melempar hasil perhitungan kembali ke halaman HTML
    let result = "BMI Anda adalah <br>" + bmi.toFixed(1) + "<br> (" + category + ")";
